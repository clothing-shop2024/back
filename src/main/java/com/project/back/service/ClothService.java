...
public interface ClothService {
    ...
    ResponseEntity<? super GetClothInfoResponseDto> getClothInfo(Integer clothNumber);

    // ResponseEntity<? super GetClothNumberResponseDto> getClothNumber(String
    // userId);

    // 찜 목록
    ResponseEntity<ResponseDto> postFavorite(String userId, Integer clothNumber);

    ResponseEntity<? super GetFavoriteClothListResponseDto> getFavoriteList(String userId);

    ResponseEntity<? super GetFavoriteCheckResponseDto> getFavoriteCheck(String userId, Integer clothNumber);

    ResponseEntity<ResponseDto> deleteFavorite(String userId, Integer clothNumber);
}
